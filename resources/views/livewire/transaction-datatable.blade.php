                ...
                <tbody class="bg-white">
                    ...
                    <tr>
                        <td class="w-1/5 px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                            <div class="text-sm leading-5 text-gray-500">{{$transaction->reference_code}}</div>
                        </td>
                        <td class="w-1/5 px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                            <div class="text-sm leading-5 text-gray-500">{{$transaction->amount}}</div>
                        </td>
            
                        <td class="w-1/5 px-6 py-4 whitespace-no-wrap border-b border-gray-200">

                            <span class="inline-flex px-2 text-xs font-semibold leading-5 w-4 h-4
                                rounded-full {{$transaction->status  == 'success' ? 'text-green-800 bg-green-500' : 'text-red-800 bg-red-500'}}">
                        ...
                        <td
                            ...
                            <div class="text-sm leading-5 text-gray-500">{{$transaction->tenant->name}}</div>
                        </td>
